...
public class ResponseFormatter {
    ...
    public String formatFaqResponse(ArrayList<Faq> response) {
        if (response.isEmpty()) {
            return "I'm sorry, I couldn't quote find the answer in our database. Could you please be more specific?";
        } else {
            StringBuilder sb = new StringBuilder();
            for (Faq faq : response) {
                sb.append(faq.getAnswer()).append("\n");
            }
            return "I found some related common FAQs.\n" + sb.toString() + "\nDid these help answer your question? (Yes/No)";
        }
    }
}
